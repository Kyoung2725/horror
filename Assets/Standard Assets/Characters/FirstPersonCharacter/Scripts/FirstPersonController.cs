...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	{   
		...
		bool isRuning = false;
		bool sneak = false;
		[SerializeField]AudioClip PlayerSprint;//ref to Audioclip played then player is running
		//new
        ...
        private void GetInput(out float speed)
        {
			...
			m_IsWalking = !isRuning;// changed for limited sprint
#endif
		...
		public void Run ()
		{			
			if (Input.GetKey (KeyCode.LeftShift) && Stamina > 0 && !sneak) //if player preses shift and has stamina remaining they run
			{
		...
		public void Hide ()
		{
			...
			{
				sneak = false;
				m_WalkSpeed=playerSpeed;
				m_CharacterController.height = 1.8f;//undo crouch
			}
		}
